    ...
    <div class="page-container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white p-0 fixed-top">
            ...
            <div class="collapse navbar-collapse p-o" id="navbarNav">
              ...
              <!--  
               <li class="nav-item">
                    <a class="nav-link" href="inscripciones3.php">Registro de Participantes</a>
                </li> -->
             ...
             <!--   <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="multimedia.php">Material multimedia</a>
                </li>
        ...
        <section id="bienvenidas-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <h3 class="text-right p-4"> <span class="green-clr"><?php $hoy= date('j'); echo '23 de noviembre de 2018';
 ?></span> </h3>
                        <div class="py-5">
